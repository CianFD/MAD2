package ie.wit.presentdeliverytracker.ui.home
...
import ie.wit.presentdeliverytracker.ui.auth.Login
...
import ie.wit.presentdeliverytracker.utils.readImageUri
import ie.wit.presentdeliverytracker.utils.showImagePicker
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(
            R.id.deliveryFragment, R.id.reportFragment, R.id.aboutFragment), drawerLayout)
